...
def info(): 
    ...
    awal() 
    print B+"\n ========================"+W+" INFO "+B+"========================="
    print B+" | "+W+"Name     "+C+":"+W+"HASH EN-DE v1 "+B+"                        |"
    print B+" | "+W+"Created   "+C+":"+W+"./"+R+""+W+"NALURI_"+B+"                   |"
    print B+" | "+W+"Blog   "+C+":"+W+" https://www.nts-7.net"+B+"                 |"
    print B+" | "+W+"Info     "+C+":"+W+"Tools Untuk Encrypt Dan De hash!"+B+"                           |"
    print B+" | "+W+"Team     "+C+":"+W+"Newbie Tersakiti Sec7"+B+"                        |"
